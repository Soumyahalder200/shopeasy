      ...
      <div className="flex flex-wrap items-center -mx-4">
        <div className="w-full px-4 md:w-2/3 lg:w-1/2">
          <ul className="flex items-center -mx-3">
            <li>
              <a href="javascript:void(0)" className="inline-block px-3 py-4 text-sm font-medium text-body-color dark:text-dark-6 hover:text-primary dark:hover:text-primary">
                About Us
              </a>
            </li>
            <li>
            ...
            <div>
              <div className="relative">
                <select className="w-full py-3 pl-3 pr-5 text-sm font-medium transition bg-transparent rounded-lg outline-none appearance-none text-body-color dark:text-dark-6">
                  ...
                  <option value="" className="dark:bg-dark-2">Urdu</option>
                  <option value="" className="dark:bg-dark-2">Hindi</option>
                </select>
      ...
      <div className="relative flex items-center justify-center -mx-4 sm:justify-between">
        <div className="w-48 max-w-full px-4 sm:w-60 lg:w-48">
          <a href="javascript:void(0)" className="block w-full py-5 lg:py-3">
            <img src="src/assets/images/logo/logo-primary.svg" alt="logo" className="w-full dark:hidden"/>
            <img src="src/assets/images/logo/logo-white.svg" alt="logo" className="hidden w-full dark:block"/>
          </a>
        </div>
        <div className="items-center justify-end hidden w-full px-4 sm:flex lg:justify-between">
          <div className="hidden w-full lg:flex">
            <form className="relative flex items-center w-full border rounded-md border-stroke dark:border-dark-3 bg-gray-2 dark:bg-dark-2">
              <div className="relative border-r border-stroke dark:border-dark-3">
                <select className="appearance-none bg-transparent pr-10 pl-[22px] py-[14px] text-base font-medium text-dark dark:text-black outline-none">
                  <option className="dark:bg-dark-2 text-black ">All categories</option>
              ...
              <input type="text" placeholder="I'm shopping for..." className="w-full bg-transparent py-3 pl-6 pr-[58px] text-base text-body-color dark:text-dark-6 outline-none"/>
              <button className="absolute top-0 right-0 flex h-full w-[52px] items-center justify-center rounded-tr-md rounded-br-md border border-primary bg-primary text-white">
          ...
          <div className="flex items-center justify-end w-full space-x-4">
            <div className="items-center hidden pr-1 md:flex">
              <div className="mr-3 flex h-[42px] w-[42px] items-center justify-center rounded-full border-[.5px] border-stroke dark:border-dark-3 bg-gray-2 dark:bg-dark-2 text-dark dark:text-black">
              ...
              <div>
                <p className="text-sm font-medium text-dark dark:text-black">
                  Need Help?
                  <br/>
                  +001 123 456 789
                </p>
            ...
            <div>
                <Link href="/login">
              <button className="relative flex h-[42px] w-[42px] items-center justify-center rounded-full border-[.5px] border-stroke dark:border-dark-3 bg-gray-2 dark:bg-dark-2 text-dark dark:text-black">
                <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg" className="fill-current">
            ...
            <div className="relative z-20">
              <div className="flex max-w-[200px] justify-end">
                <button  className="relative flex h-[42px] w-[42px] items-center justify-center rounded-full border-[.5px] border-stroke dark:border-dark-3 bg-gray-2 dark:bg-dark-2 text-dark dark:text-black">
                  ...
                  <span className="absolute -top-1 -right-1 h-[18px] w-[18px] rounded-full bg-primary leading-[18px] text-[10px] font-semibold text-black">
                    3
                  </span>
                </button>
              </div>
              <div   className="absolute top-full right-0 mt-5 w-[330px]" style={{display: "none"}}>
                <div className="px-6 py-8 overflow-hidden bg-white border rounded-lg border-stroke dark:border-dark-3 dark:bg-dark-2 shadow-1 dark:shadow-box-dark">
                  <div className="pb-3 border-b border-stroke dark:border-dark-3">
                    <div className="flex items-center justify-between pb-4 -mx-1">
                      <div className="flex items-center px-1">
                        <div className="mr-3 h-10 w-full max-w-[40px] overflow-hidden rounded">
                          <img src="src/assets/ecom-images/checkout/checkout-02/image-02.jpg" alt="product image" className="w-full"/>
                        </div>
                        <div>
                          <a href="javascript:void(0)" className="text-sm font-medium text-dark dark:text-white hover:text-primary">
                            Circular Sienna
                          </a>
                    ...
                    <div className="flex items-center justify-between py-4 -mx-1">
                      <div className="flex items-center px-1">
                        <div className="mr-3 h-10 w-full max-w-[40px] overflow-hidden rounded">
                          <img src="src/assets/ecom-images/checkout/checkout-02/image-03.jpg" alt="product image" className="w-full"/>
                        </div>
                        <div>
                          <a href="javascript:void(0)" className="text-sm font-medium text-dark dark:text-white hover:text-primary">
                            Black T-shirt
                  ...
                  <div>
                    <button className="flex w-full items-center justify-center rounded-md bg-primary py-[10px] px-10 text-center text-base font-medium text-white hover:bg-blue-dark">
                      Add to Cart
                    </button>
                  </div>
                </div>
            ...
            <div className="relative z-20">
              ...
              <div x-show="cartOpen"  className="absolute top-full right-0 mt-5 w-[330px]" style={{display: "none"}}>
                <div className="p-8 overflow-hidden bg-white rounded-lg dark:bg-dark-2 shadow-1 dark:shadow-box-dark">
                  ...
                  <div>
                    <button className="flex w-full items-center justify-center rounded-md bg-primary py-[13px] px-10 text-center text-base font-medium text-white hover:bg-blue-dark">
                      Place Order
                    </button>
                  </div>
                </div>
      ...
      <div className="relative flex items-center justify-between -mx-4">
        <div className="w-full max-w-full px-4 lg:w-60">
          <div className="relative py-4 " >
            <a href=" " className="inline-flex items-center justify-between whitespace-nowrap rounded-[5px] bg-primary pl-4 pr-[18px] py-[9px] text-base font-medium text-black hover:bg-opacity-90">
              <span className="pr-[10px] text-black">
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg" className="fill-current">
                  <path d="M16.875 8.38125H1.12502C0.787524 8.38125 0.478149 8.6625 0.478149 9.02812C0.478149 9.36562 0.759399 9.675 1.12502 9.675H16.875C17.2125 9.675 17.5219 9.39375 17.5219 9.02812C17.5219 8.6625 17.2125 8.38125 16.875 8.38125Z"></path>
                  <path d="M16.875 13.1625H1.12502C0.787524 13.1625 0.478149 13.4437 0.478149 13.8094C0.478149 14.175 0.759399 14.4562 1.12502 14.4562H16.875C17.2125 14.4562 17.5219 14.175 17.5219 13.8094C17.5219 13.4437 17.2125 13.1625 16.875 13.1625Z"></path>
                  <path d="M1.12502 4.8375H16.875C17.2125 4.8375 17.5219 4.55625 17.5219 4.19062C17.5219 3.825 17.2406 3.54375 16.875 3.54375H1.12502C0.787524 3.54375 0.478149 3.825 0.478149 4.19062C0.478149 4.55625 0.787524 4.8375 1.12502 4.8375Z"></path>
                </svg>
              </span>
              ...
              <span className="pl-3 text-black">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="fill-current">
                  <path d="M8.00002 11.4C7.85002 11.4 7.72502 11.35 7.60002 11.25L1.85002 5.6C1.62502 5.375 1.62502 5.025 1.85002 4.8C2.07502 4.575 2.42502 4.575 2.65002 4.8L8.00002 10.025L13.35 4.75C13.575 4.525 13.925 4.525 14.15 4.75C14.375 4.975 14.375 5.325 14.15 5.55L8.40002 11.2C8.27502 11.325 8.15002 11.4 8.00002 11.4Z"></path>
                </svg>
              </span>
            </a>

            <div  className="absolute left-0 top-[115%] z-10 w-[180px] rounded-lg border-[.5px] border-stroke dark:border-dark-3 bg-white dark:bg-dark-2 py-4 transition-all hidden">
              <span className="absolute -top-[6px] left-6 -z-10 hidden h-3 w-3 rotate-45 rounded-sm border-[.5px] border-r-0 border-b-0 border-stroke dark:border-dark-3 bg-white dark:bg-dark-2 lg:block"></span>
              <div className="pl-6 pr-[18px]">
                <a href="javascript:void(0)" className="flex items-center justify-between py-[6px] text-sm text-body-color dark:text-dark-6 hover:text-primary">
                  Arts &amp; Crafts
                </a>
              </div>
                  ...
                  <div className="flex flex-wrap -mx-2">
                    <div className="w-full px-2 lg:w-1/3">
                      <div>
                        ...
                        <a href="javascript:void(0)" className="block py-[6px] text-base text-body-color dark:text-dark-6 hover:text-primary">
                          Dresses
                        </a>
                        <a href="javascript:void(0)" className="block py-[6px] text-base text-body-color dark:text-dark-6 hover:text-primary">
                          Jackets
                    ...
                    <div className="w-full px-2 lg:w-1/3">
                      <a href="javascript:void(0)" className="rounded">
                        <img src="src/assets/ecom-images/navbars/navbar-02/bannder.jpg" alt="banner" className="w-full rounded"/>
                      </a>
                    </div>
                  </div>
                </div>
        ...
        <div className="flex items-center justify-between w-full px-4">
          <div className="w-full">
            ...
            <nav id="navbarCollapse" className="absolute right-4 top-full z-50 w-full max-w-[250px] justify-center rounded-lg bg-white dark:bg-dark-2 py-5 px-6 shadow lg:static lg:flex lg:w-full lg:max-w-full lg:justify-end lg:bg-transparent lg:py-0 lg:px-0 lg:shadow-none dark:lg:bg-transparent hidden">
              <ul className="items-center block lg:flex">
                <li>
                  <a href="javascript:void(0)" className="flex justify-between py-2 text-base font-medium text-body-color dark:text-dark-6 hover:text-primary lg:mx-4 lg:inline-flex lg:py-6">
                    Mens
                  </a>
                </li>
                <li>
