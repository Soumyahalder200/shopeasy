...
const Footer = () => {
  ...
  <div className="container mx-auto">
    <div className="px-6 pt-20 pb-6 border rounded-lg bg-gray dark:bg-dark-2 border-stroke dark:border-dark-3 sm:px-8 xl:px-14">
      <div className="flex flex-wrap -mx-4">
        <div className="w-full px-4 md:w-5/12 lg:w-1/3">
          <div className="mb-14">
            <a href="javascript:void(0)" className="inline-block mb-8">
              <img src="src/assets/images/logo/logo.svg" alt="" className="max-w-full dark:hidden"/>
              <img src="src/assets/images/logo/logo-white.svg" alt="" className="hidden max-w-full dark:block"/>
            </a>
            ...
            <div className="flex flex-wrap -mx-4 space-y-3 sm:space-y-0 lg:space-y-3 xl:space-y-0">
              <div className="w-full px-4 sm:w-1/2 lg:w-full xl:w-1/2">
                <ul className="space-y-3">
                  <li>
                    <a href="javascript:void(0)" className="inline-block text-base text-body-color dark:text-dark-6 hover:text-primary">
                      Legal &amp; Privacy
                    </a>
                  </li>
                  <li>
        ...
        <div className="w-full px-4 md:w-8/12 lg:w-1/3">
          <div className="mb-14">
            ...
            <form className="flex items-center justify-between">
              <input type="email" placeholder="Enter your email" className="focus:border-primary h-[54px] w-full rounded-tl-lg rounded-bl-lg border border-stroke dark:border-dark-3 bg-white dark:bg-dark px-5 outline-none"/>
              <button className="h-[54px] rounded-tr-lg rounded-br-lg border border-l-0 border-stroke dark:border-dark-3 bg-white dark:bg-dark px-5">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M21 3.59998H3.00001C1.72501 3.59998 0.637512 4.64998 0.637512 5.96248V18.1125C0.637512 19.3875 1.68751 20.475 3.00001 20.475H21C22.275 20.475 23.3625 19.425 23.3625 18.1125V5.92498C23.3625 4.64998 22.275 3.59998 21 3.59998ZM21 5.28748C21.0375 5.28748 21.075 5.28748 21.1125 5.28748L12 11.1375L2.88751 5.28748C2.92501 5.28748 2.96251 5.28748 3.00001 5.28748H21ZM21 18.7125H3.00001C2.62501 18.7125 2.32501 18.4125 2.32501 18.0375V6.93748L11.1 12.5625C11.3625 12.75 11.6625 12.825 11.9625 12.825C12.2625 12.825 12.5625 12.75 12.825 12.5625L21.6 6.93748V18.075C21.675 18.45 21.375 18.7125 21 18.7125Z" fill="#3758F9"></path>
                </svg>
              </button>
            </form>
          </div>
    ...
    <div className="px-6 py-8 pb-6 sm:px-8 xl:px-14">
      <div className="flex flex-wrap items-center -mx-4">
        <div className="w-full px-4 xl:w-8/12">
          <div className="flex flex-wrap justify-center -mx-3 xl:justify-start">
            <a href="javascript:void(0)" className="inline-flex px-3 mb-4 text-base text-body-color dark:text-dark-6 hover:text-primary">
              Payment
            </a>
            <a href="javascript:void(0)" className="inline-flex px-3 mb-4 text-base text-body-color dark:text-dark-6 hover:text-primary">
              Shipping &amp; Returns
        ...
        <div className="w-full px-4 xl:w-4/12">
          <div className="mt-2 xl:mt-0 xl:mb-4">
            <img src="src/assets/ecom-images/footers/footer-02/payment.svg" alt="payment" className="max-w-full mx-auto xl:ml-0"/>
          </div>
        </div>
      </div>
    </div>
